...
=======
author: "Andrzej Janusz"
>>>>>>> c98ede0d9291070b52ccf5af016c84c97d6a1103
output:
  html_notebook:
    df_print: paged
    fig_height: 8
...
<<<<<<< HEAD
dist_vector <- as.numeric(proxy::dist(dataSet[1, !"diagnosis"], dataSet[, !"diagnosis"])) #to juz da wszystkie odleglosci
=======
...
my_knn(dataSet[-1, !"diagnosis"], dataSet[1, ], )

=======
#moje
x <- my_knn(dataSet[-c(1:15), !"diagnosis"], dataSet[c(1:15), !"diagnosis"], dataSet[-c(1:15), "diagnosis"])
y <- dataSet[c(1:15), diagnosis]
x
y
dataSet[1:3, diagnosis]  #cos istotnego
#moje
mean(as.character(x) == as.character(y))
# sprawdź, że powyższa funkcja rzeczywiście działa
...
=======
tree_learner$train(wdbc_task, row_ids = training_set_idxs)
prediction <- tree_learner$predict(wdbc_task, row_ids = test_set_idxs)
>>>>>>> c98ede0d9291070b52ccf5af016c84c97d6a1103
prediction$score(measures)
